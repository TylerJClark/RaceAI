import pygame
class Button():
    def __init__(self,x,y,width,height,colour,colourH,border=False,borderC=(0,0,0),text="",font=0,size=30):#Initialise all of the variables
    ...
    def create(self,screen):#Method to blit the button onto the screen
        ...
        if self.text != "":#checks if there is text for the button
            text= self.font.render(self.text,1,(0,0,0))#creates the text
